...
**Canvas Demo** is an app that allows users to use gestures in order to create fun pictures using a variety of images.
...
<img src='https://imgur.com/oMIeF8J.gif' title='Canvas Demo' width='373' alt='Canvas Walkthrough' />
